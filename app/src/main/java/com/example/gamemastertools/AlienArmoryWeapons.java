...
import com.example.gamemastertools.databinding.FragmentAlienArmoryWeaponsBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class AlienArmoryWeapons extends Fragment{

    private FragmentAlienArmoryWeaponsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAlienArmoryWeaponsBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnArmoryRandomWeapon.setOnClickListener(v -> {
