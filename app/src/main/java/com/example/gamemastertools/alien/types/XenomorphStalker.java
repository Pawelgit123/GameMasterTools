...
public class XenomorphStalker extends AlienXenoCreature implements AlienXenoAttack {
    ...
    public String  makeAttackText(int roll) {
        ...
        switch (roll){
            ...
            case 4:
            case 7: return "The Xenomorph grabs its victim, its inner jaws poised to strike. Roll the attack with 10d6. If it hits, the victim counts as grabbed (pg.93) and needs to make an opposed CLOSE COMBAT roll against 10d6 to break lose. The victim and all friendly characters in the same zone must make Panic Rolls. Unless the victim breaks free, the Xenomorph will use a HEADBITE attack against them on its next initiative.";
