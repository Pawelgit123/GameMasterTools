...
public class NeomorphNeophyte extends AlienXenoCreature implements AlienXenoAttack {
    ...
    public String  makeAttackText(int roll) {
        ...
        switch (roll){
            ...
            case 3:
            case 7: return "The Neomorph jumps at its victim, grabbing it and dragging it away. Roll for the attack using 8d6, Damage 1. If it hits, the Neomorph immediately drags the victim into the next zone (MEDIUM range) before releasing it. The victim falls prone, drops any hand-held items and must make an immediate Panic Roll.";
            case 4: return "The Neomorph jumps at the victim. Roll for the attack using 8d6, Damage 1. If the attack is successful, the victim is thrown to the ground and must make an immediate Panic Roll, and the Neomorph immediately performs an extra attack with 10d6, Damage 2. The extra attack cannot be blocked.";
