...
public class AlienWeaponCreatorAuraxis {
    ...
    public static AlienWeapon createEridani() {
        return new AlienWeapon.Builder()
                ...
                .range("Medium")
                .cost(7000)
                .specials("Auto:4 / Armor -1 / H-Capacity / Overheat")
                .ammo("Battery-AP")
                .weight("1")
                .build();
    }
    ...
    public static AlienWeapon createEquinox() {
        return new AlienWeapon.Builder()
                ...
                .range("Long")
                .cost(8000)
                .specials("Auto:2 / Armor -1 / Overheat")
                .ammo("Battery-AP")
                .weight("1")
                .build();
    }
    ...
    public static AlienWeapon createPolaris() {
        return new AlienWeapon.Builder()
                ...
                .range("Long")
                .cost(23000)
                .specials("Auto:1 / Armor -2 / Overheat")
                .ammo("Battery-AP")
                .weight("2")
                .build();
    }
    ...
    public static AlienWeapon createSlicer() {
        return new AlienWeapon.Builder()
                ...
                .range("Extreme")
                .cost(55000)
                .specials("Scope / CriticalHit / Overheat")
                .ammo("Battery-AP")
                .weight("3")
                .build();
    }
    ...
    public static AlienWeapon createSpectre() {
        return new AlienWeapon.Builder()
                ...
                .range("Extreme")
                .cost(70000)
                .specials("Scope / CriticalHit / H-Capacity / Overheat")
                .ammo("Battery-AP")
                .weight("2")
                .build();
    }
    ...
    public static AlienWeapon createQuasar() {
        return new AlienWeapon.Builder()
                ...
                .range("Extreme")
                .cost(45000)
                .specials("Auto:1 / H-Capacity / Overheat")
                .ammo("Battery-AP")
                .weight("3")
                .build();
    }
