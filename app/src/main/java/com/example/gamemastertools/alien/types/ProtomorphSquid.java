...
public class ProtomorphSquid extends AlienXenoCreature implements AlienXenoAttack {
    ...
    public String  makeAttackText(int roll) {
        ...
        switch (roll){
            ...
            case 2:
            case 3:
            default:return "In a bur of whipping tentacles, the Squid flees one zone away, slipping into the nearest cover or air duct if possible. As soon as the PCs lose line of sight, combat ends and stealth mode ensues. After one shift, the squid grows into a Trilobite and begins looking for a host to implant.";
